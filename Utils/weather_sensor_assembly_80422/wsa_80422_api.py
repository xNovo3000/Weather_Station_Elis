...
wind_count = 0
rain_sensor_count = 0
rain_sensor_switch_reed = Button(Configuration.RAIN_GAUGE_BUTTON_GPIO_PIN_NUMBER)
wind_speed_sensor_switch_reed = Button(Configuration.WIND_SENSOR_BUTTON_GPIO_PIN_NUMBER)
store_speeds = []
...
def init_wind_speed_sensor():
    '''

    :return:
    '''
    try:
        global wind_speed_sensor_switch_reed
...
def init_rain_sensor():
    '''

    :return:
    '''
    try:
        global rain_sensor_switch_reed
